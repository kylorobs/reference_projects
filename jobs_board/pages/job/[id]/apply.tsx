...
import { getJob, JobWithAuthor } from '../../../lib/data';
import { prisma } from '../../../lib/prisma';

export default function Apply({ job }: { job: JobWithAuthor }) {
    ...
    return (
        ...
        >
            <div className="flex flex-col w-1/2 mx-auto">
                ...
                <div className="mt-5">
                    <button type="submit" className="border float-right px-8 py-2 mt-0  font-bold rounded-full">
                        Apply to this job
                    </button>
                </div>
            </div>
